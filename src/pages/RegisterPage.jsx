      ...
      <main className="pt-24 pb-stack-lg px-margin-mobile max-w-xl mx-auto">
        ...
        <form className="space-y-stack-md" onSubmit={handleSubmit}>
          ...
          <div className="pt-stack-lg">
            <button
              type="submit"
              className="w-full bg-primary-container text-white py-4 rounded-xl font-headline-sm text-headline-sm shadow-[0_4px_20px_rgba(98,54,255,0.3)] active:scale-[0.98] transition-all flex items-center justify-center gap-2"
            >
              Sign Up
