...
const PRODUCTS = [
  ...
  {
    id: 2,
    name: 'Sonic Flow Buds',
    desc: 'Immersive soundscapes',
    price: '$499',
  ...
  {
    id: 4,
    name: 'Vision Goggles Pro',
    desc: 'Beyond reality tech',
    price: '$899',
...
const USER_IMG =
  'https://lh3.googleusercontent.com/aida-public/AB6AXuDrZsUwNf37MvfES-nhq1mfFEynErVgdr7psrsPw9RKHqAp9Hu2dvajDmFFqtLfoTNtB3bjwi-IXsmXp4ZfZ7CKbCbsvErlHBJ4JMAtoa8x6UetLrWJnStEzDWETlldfL5NxROc8R2D6OEqRK2Nk7jxx-xkckHZC7nN2NXDhAuI2Su82fK2g6zh4EPUB4SZPcOA16mmQ09iIb7wS7N2WfBa-OWdV2XXWatmuNeq109W8PqID3Pp36-azOgf73z0ShmmZiPysaOVzQwc'

const SIDEBAR_IMG =
  'https://lh3.googleusercontent.com/aida-public/AB6AXuCDFVIxz03gE2aWx_8DGNmp79yP9JBRI-0xQtpKGriaEP0wXB8E9FdvXKUEgNlTy68zqmZ-mOq2w1o2w1xVDOLELIGMY3nFJPwdpkE9mkruC5HtYwH_qwFGv0YWYGTGz7pZWEZLu9Y3r5tdoI59WH9UtfNJasGP1vqOH1268nnTSw2HGu_Ccd4OXTqqKd_mACTmP7H27UcXtJGBpSx1HMkiSlDu590PMy-KT4EENUVjLjh3GIm9uieUBDzD3x344oGZihWdnVTPxVlV'
...
export default function ShopPage() {
  ...
  return (
    <div className="min-h-screen bg-[#F0F0F0] text-[#e5e1e4]">
          ...
          <div className="relative" ref={dropdownRef}>
            ...
            {dropdownOpen && (
              <div className="absolute right-0 mt-2 w-48 bg-surface-container-highest border border-outline-variant rounded-xl py-2 z-10 shadow-lg">
                <a
                  href="#"
                  className="block px-4 py-2 font-body-md text-on-surface hover:bg-primary/10 transition-colors"
                >
                  Ver perfil
                </a>
                <a
                  href="#"
                  className="block px-4 py-2 font-body-md text-error hover:bg-error/10 transition-colors"
                >
                  Cerrar sesión
                </a>
              </div>
      ...
      {/* ── Navigation Drawer ── */}
      <nav
        className={`bg-surface-container h-full w-72 rounded-r-xl shadow-2xl fixed inset-y-0 left-0 z-[60] flex flex-col transition-transform duration-300
      ...
      >
        <div className="p-6 flex flex-col gap-1">
          ...
          <h2 className="font-headline-sm text-headline-sm text-primary">Future Shopper</h2>
